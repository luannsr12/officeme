                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                           <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="0%" name="{{$gateway}}[taxa_saque]" id="{{$gateway}}_taxa_saque">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Client id" name="{{$gateway}}[client_id]" id="{{$gateway}}_client_id">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Client Secret" name="{{$gateway}}[client_secret]" id="{{$gateway}}_client_secret">
                            </div>
                        </div>
