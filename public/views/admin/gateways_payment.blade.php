    ...
    <div class="container-fluid py-4">
            ...
            <div class="row mb-3">
                <div class="col-md-6 col-6">
                    <a href="<?= APP_URL; ?>/p/bots/settings/{{ $bot->id }}" class="btn bg-gradient-primary w-100 w-lg-50" > <i class="fa fa-arrow-left"></i>  Voltar</a>
                 </div>
            </div>
                        ...
                        <div class="col-lg-2 col-6 col-md-6">
                            <div class="card">
                                ...
                                <div class="pt-0 mt-0 text-center card-body">
                                    ...
                                    <a href="<?= APP_URL ?>/p/bots/settings/payments/<?= $gate->name; ?>/{{ $bot->id }}" class="w-100 mt-2 btn bg-gradient-primary" > <i class="fa fa-cogs"></i> Configurar</a> 
                                </div>
                            </div>
                        </div>
