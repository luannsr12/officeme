                                    ...
                                    <div class="btn-group btn-group-responsive-customers" role="group" aria-label="Button group with nested dropdown">
                                        ...
                                        <div class="btn-group btn-filter-customers" role="group">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="btnGroupDropFilter">
                                                ...
                                                <a class="dropdown-item" href="javascript:filterByServer('with_alert');"><i class="fa fa-server"></i> Por plataforma</a>
                                            </div>
                                        </div>
                                                    ...
                                                    <thead>
                                                        ...
                                                        <th data-dt-column="5"
                                                            ...
                                                            <th data-dt-column="4"
                                                                ...
                                                                <span class="dt-column-title" role="button">Plataforma</span><span class="dt-column-order"></span>
                                                            </th>
                                                            <th data-dt-column="5"
                                                                class="dt-orderable-asc dt-orderable-desc dtr-hidden"
                                                                rowspan="1" colspan="1"
                                                                aria-label="Salary: Act
                                                                ivate to sort" tabindex="0"
                                                                style="display: none;"><span class="dt-column-title"
...
</html><?php /**PATH C:\wamp64\www\workspace\jobs\balancebet\public\views/admin/customers.blade.php ENDPATH**/ ?>