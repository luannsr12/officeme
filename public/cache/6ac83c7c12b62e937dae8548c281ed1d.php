              ...
              <div class="card card-plain mt-8 bg-white">
                ...
                <div class="card-body">
                  <form role="form">
                    ...
                    <div class="mb-3">
                      <input type="text" class="form-control" placeholder="Email ou usuário" id="username" aria-label="Email ou usuário" aria-describedby="user-addon">
                    </div>
                    <label>Senha</label>
                    <div class="mb-3">
                    ...
                    <div class="text-center">
                      ...
                      <p style="font-size:11px;" class="mt-2" >Ou</p>
...
</html><?php /**PATH C:\wamp64\www\workspace\jobs\gestorlite\public\views/login.blade.php ENDPATH**/ ?>