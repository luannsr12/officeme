          ...
          <div class="card bg-white">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold responsive-text">Meu saldo</p>
          ...
          <div class="card bg-white">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Saques</p>
                    <h5 class="font-weight-bolder mb-0">
                      1
                    </h5>
                  </div>
...
</html><?php /**PATH C:\wamp64\www\workspace\jobs\balancebet\public\views/user/dashboard.blade.php ENDPATH**/ ?>