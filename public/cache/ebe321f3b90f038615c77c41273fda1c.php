                                    ...
                                    <div class="btn-group btn-group-responsive-customers" role="group"
                                        ...
                                        <div class="btn-group btn-filter-customers" role="group">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="btnGroupDropFilter">
                                                <a data-label="Entradas" id="filter_deposit" class="dropdown-item"
                                                    href="javascript:filterFinancial('deposit', 1);"><i
                                                        class="fa fa-arrow-up"></i>
                                                    Entradas</a>

                                                <a data-label="Saídas" id="filter_withdraw" class="dropdown-item"
                                        ...
                                        <div class="btn-group btn-more-customers" role="group">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="btnGroupDropPlus">
                                                <a class="dropdown-item" href="#"><i class="fa fa-upload"></i>
                                                    Importar</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Pagamento água" id="description">
                            </div>
                        </div>
...
</html><?php /**PATH C:\wamp64\www\workspace\jobs\bottelegramphp\public\views/financial.blade.php ENDPATH**/ ?>