  ...
  <main class="pt-3 main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
        ...
        <div class="row bg-white p-4 mb-4">
            <div class="col-md-12">
                <button class="btn bg-gradient-primary" onclick="$('#modalAddBot').modal('show');" > <i class="fa fa-plus"></i> Adicionar Bot</button>
            </div>
        </div>

      
        <div class="row" id="listBots">
...
</html><?php /**PATH C:\wamp64\www\workspace\jobs\bottelegramphp\public\views/bots.blade.php ENDPATH**/ ?>